# -*- coding: utf-8 -*-
"""
Created on Fri May 17 22:47:45 2024

@author: valie
"""

# My Agent Model : All the Code use in this Lab are from Professor's Levy Lecture
# The Agent model is too complex to have been giving only less than 2 day 
# for us to replicate it like this, considering the content we learned and 
# the pace at which we learned those contents
# To be honest, I reviewed the code given by the Professor more than 4 times
# and I still couldn't fully understand the logic. I did understand the syntax for Python
# but not all the logic for the Agent model.
...
params = {'world_size':(2,2),
          ...
          'same_pref' :0.4,
          'max_iter'  :10,
          'out_path'  :r'N:\3 MES DOSSIERS SECONDAIRES\MASTER PREPARATION PROGRAM\University of Chicago\Academic Section\Course Materials\DAP I\MyGitHub\Lab9DAP1' }
